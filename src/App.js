...
import WorkStory from './component/resources/WorkStory';
import Cbc from './component/resources/Cbc';
import CaseStudy1 from './component/homelinks/letter/CaseStudy1';
...
import Downloads from './component/resources/Downloads';
import Joy from './component/more/Joy';
import Scholar from './component/more/Scholar';
import Govscheme from './component/more/Govscheme';
...
const App = () => {
  ...
  <Routes>
    ...
    <Route path="/workstory" Component={WorkStory}/>
    <Route path="/cbc" Component={Cbc}/>
    <Route path="/cs1" Component={CaseStudy1}/>
    <Route path="/downloads" Component={Downloads}/>
    <Route path="/joy" Component={Joy}/>
    <Route path="/scholar" Component={Scholar}/>
    <Route path="/govs" Component={Govscheme}/>
